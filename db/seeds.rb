...
kiosks = Booth.create(name: 'Brannan_kiosk', street: '475 Brannan St', city: 'San Francisco', state: 'CA', zipcode: '94107', lng: 37.7786, lat: -122.3953)
kiosks = Booth.create(name: 'Clementina_kiosk', street: '321 Clementina St', city: 'San Francisco', state: 'CA', zipcode: '94103', lng: 37.7819, lat: -122.4021)
kiosks = Booth.create(name: 'Sutter_kiosk', street: '130 Sutter St', city: 'San Francisco', state: 'CA', zipcode: '94104', lng: 37.7902, lat: -122.4031)
kiosks = Booth.create(name: 'Kearny_kiosk', street: '750 Kearny St', city: 'San Francisco', state: 'CA', zipcode: '94108', lng: 37.7951, lat: -122.4043)
